...
$plugin_tx['pagemanager']['error_cant_rename']="Stránku nemožno premenovať, lebo jej nadpis je čiastočne formátovaný.";
...
$plugin_tx['pagemanager']['op_create']="Vytvoriť stránku (ako podstránku)";
$plugin_tx['pagemanager']['op_create_after']="Vytvoriť stránku (na rovnakej úrovni - za poslednou podstránkou)";
$plugin_tx['pagemanager']['op_cut']="Vystrihnúť";
$plugin_tx['pagemanager']['op_delete']="Vymazať stránku (vrátane podstránok)";
...
$plugin_tx['pagemanager']['op_paste']="Vložiť (ako podstránku)";
