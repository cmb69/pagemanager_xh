...
$plugin_tx['pagemanager']['error_structure_warning']="<strong>Chybná struktura stránek.</strong> Kontaktuje správce stránek!\r\nPokud budete pokračovat fixován Pagemanager_XH, což nemusí být to, co chcete.";
...
$plugin_tx['pagemanager']['op_collapse']="Minimalizovat všechny stránek";
$plugin_tx['pagemanager']['op_copy']="Kopírovat";
$plugin_tx['pagemanager']['op_create']="Vytvořit stránku (jako podstránku)";
$plugin_tx['pagemanager']['op_create_after']="Vytvořit stránku (na stejné úrovni>)";
$plugin_tx['pagemanager']['op_cut']="Vystřihnout";
$plugin_tx['pagemanager']['op_delete']="Vymazat stránku (včetně podstran)";
...
$plugin_tx['pagemanager']['op_paste']="Vložit (jako podstranu)";
