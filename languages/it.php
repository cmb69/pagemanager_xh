...
$plugin_tx['pagemanager']['button_save']="Salva";
$plugin_tx['pagemanager']['op_expand']="Espandi tutte le pagine";
$plugin_tx['pagemanager']['op_collapse']="Contrai tutte le pagine";
$plugin_tx['pagemanager']['op_create']="Crea una pagina (come pagina dipendente)";
$plugin_tx['pagemanager']['op_create_after']="Crea una pagina (allo stesso livello)";
$plugin_tx['pagemanager']['op_rename']="Rinomina la pagina";
$plugin_tx['pagemanager']['op_delete']="Elimina la pagina (incluse le pagine dipendenti)";
$plugin_tx['pagemanager']['op_cut']="Taglia";
$plugin_tx['pagemanager']['op_copy']="Copia";
$plugin_tx['pagemanager']['op_paste']="Incolla (come pagina dipendente)";
$plugin_tx['pagemanager']['op_paste_after']="Incolla (allo stesso livello)";
...
$plugin_tx['pagemanager']['message_confirm']="Conferma";
