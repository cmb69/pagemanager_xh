...
$plugin_tx['pagemanager']['op_create']="Créer une page (en sous-page)";
$plugin_tx['pagemanager']['op_create_after']="Créer une page (même niveau, après les sous-pages)";
$plugin_tx['pagemanager']['op_rename']="Renommer la page";
$plugin_tx['pagemanager']['op_delete']="Supprimer la page (avec ses sous-pages)";
$plugin_tx['pagemanager']['op_cut']="Couper";
$plugin_tx['pagemanager']['op_copy']="Copier";
$plugin_tx['pagemanager']['op_paste']="Coller (en sous-page)";
$plugin_tx['pagemanager']['op_paste_after']="Coller (même niveau, après les sous-pages)";
...
$plugin_tx['pagemanager']['button_save']="Enregistrer";
