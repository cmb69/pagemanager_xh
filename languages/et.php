...
$plugin_tx['pagemanager']['button_save']="Salvesta";
$plugin_tx['pagemanager']['op_expand']="Laienda kõik lehed";
$plugin_tx['pagemanager']['op_collapse']="Kõigi lehtede kollaps";
$plugin_tx['pagemanager']['op_create']="Loo leht (<em>alamlehena</em>)";
$plugin_tx['pagemanager']['op_create_after']="Loo leht (<em>samal tasemel - alamlehtede järele</em>)";
$plugin_tx['pagemanager']['op_rename']="Nimeta ümber";
$plugin_tx['pagemanager']['op_delete']="Kustuta leht (<em>kaasaarvatud alamlehed</em>)";
$plugin_tx['pagemanager']['op_cut']="Lõika";
$plugin_tx['pagemanager']['op_copy']="Kopeeri";
$plugin_tx['pagemanager']['op_paste']="Kleebi (<em>alamlehena</em>)";
$plugin_tx['pagemanager']['op_paste_after']="Kleebi (<em>samale tasemele - pärast alamlehti</em>)";
...
$plugin_tx['pagemanager']['message_confirm']="Kinnitus";
...
$plugin_tx['pagemanager']['error_structure_warning']="<strong>Leiti korrapäratu lehestruktuur.</strong> Täpsemalt vaata lisa abimaterjali ja pea nõu oma veebimeistriga!";
